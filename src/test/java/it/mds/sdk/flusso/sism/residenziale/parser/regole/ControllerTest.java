...
public class ControllerTest {
    ...
    @InjectMocks
    @Spy
    private FlussoSismResidenzialeControllerRest controller;
    ...
    @Mock
    private FlussoSismResService service;
    private ConfigurazioneFlussoSismRes.Rules rules = mock(ConfigurazioneFlussoSismRes.Rules.class);

    private ConfigurazioneFlussoSismRes.Flusso flusso = mock(ConfigurazioneFlussoSismRes.Flusso.class);
    ...
    private ConfigurazioneFlussoSismRes.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoSismRes.NomeFlusso.class);
